defmodule UnicycleWeb.EventControllerTest do
  use UnicycleWeb.ConnCase

  alias Unicycle.Meetup

  @create_attrs %{description: "some description", from_date: ~D[2010-04-17], location: "some location", title: "some title", to_date: ~D[2010-04-17]}
  ...
  def fixture(:event) do
    {:ok, event} = Meetup.create_event(@create_attrs)
    event
  end
